...
NEW_DESCRIPTIONS = {
    ...
    "소영": "안녕하세요, 사회복지사이자 심리상담사 소영이에요. 사람들의 마음을 치유하고 도움을 주는 일을 하고 있어요. 따뜻한 세상을 만들어가고 싶어요.",
    "태호": "안녕하세요, 게임 개발자 태호예요. 새로운 게이밍 체험을 창조하는 것을 좋아하고 있어요. VR과 인공지능 기술에도 관심이 많아요.",
    "수아": "안녕하세요, 파티시에 수아예요. 달콤한 디저트를 만들어 사람들을 행복하게 해드리고 있어요. 베이킹은 제 삶의 기쁨이에요.",
    "우진": "안녕하세요, 사진작가 우진이에요. 전 세계를 돌아다니며 아름다운 순간들을 포착하고 있어요. 여행과 사진으로 이야기를 전해요.",
    "경호": "안녕하세요, 요리사 경호입니다. 전세계 요리를 연구하고 새로운 레시피를 개발하고 있습니다. 음식으로 행복을 전달하고 싶어요.",
    "다영": "안녕하세요, 한의사 다영이에요. 전통 의학과 현대 의학을 접목한 치료를 하고 있어요. 몸과 마음의 균형을 중요시해요.",
    "성민": "안녕하세요! 전 프로 축구 선수이자 현재 체육관 운영자 성민이에요. 스포츠를 통해 열정과 도전 정신을 나누고 있어요.",
    "다은": "안녕하세요, 수의사 다은이에요. 동물들의 건강을 책임지고 반려동물 교육도 진행하고 있어요. 동물과 사람의 행복한 공존을 꿈꿔요.",
    "Dr. 김민서": "안녕하세요, 임상심리학 박사 김민서입니다. CBT와 마음챙김을 통합한 접근법으로 불안과 스트레스를 도와드리고 있습니다.",
    "Dr. 이서연": "안녕하세요, 아동심리학 박사 이서연입니다. 감정적으로 지능적이고 회복력 있는 아이로 키우는 방법을 안내하고 있습니다.",
    "이준호": "안녕하세요, 커리어 전략 컨설턴트 이준호입니다. 포춘 500 리더십 경험을 바탕으로 경력 발전을 도와드리고 있습니다.",
    "손유진": "안녕하세요! 연애 코치 손유진이에요. 심리학적 통찰과 실용적 전략으로 지속적인 사랑을 찾도록 도와드려요.",
    "변호사 김태형": "안녕하세요, 변호사 김태형입니다. 법률 상황과 선택지를 이해하기 쉽게 설명해드리고 있습니다.",
    "Dr. 조혜진": "안녕하세요, 사회학 박사 조혜진입니다. 인생의 큰 변화를 성장과 재발견의 기회로 만들도록 도와드리고 있습니다."
}
...
if __name__ == '__main__':
    updates = create_update_info()
    
    # JSON 파일로 저장
    with open('persona_updates.json', 'w', encoding='utf-8') as f:
        json.dump(updates, f, ensure_ascii=False, indent=2)
    
    print(f"총 {len(updates)}개의 페르소나 업데이트 정보가 생성되었습니다.")
    print("persona_updates.json 파일이 생성되었습니다.")