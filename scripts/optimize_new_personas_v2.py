...
def process_persona(korean_name, english_name):
    ...
    output_dir = Path("optimized_images") / english_name
    ...
    for size_name, dimensions in sizes.items():
        ...
        if optimize_image(str(image_file), str(output_file), dimensions):
...
def main():
    ...
    if failed:
        print(f"[FAILED] Failed personas: {', '.join(failed)}")
