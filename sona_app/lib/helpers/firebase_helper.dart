...
class FirebaseHelper {
  ...
  static DocumentReference<Map<String, dynamic>> userChat(String userId, String personaId) => 
      userChats(userId).doc(personaId);
      
  static CollectionReference<Map<String, dynamic>> userChatMessages(String userId, String personaId) => 
  ...
  static CollectionReference<Map<String, dynamic>> get userPersonaRelationships => 
      _firestore.collection(AppConstants.userPersonaRelationshipsCollection);
  ...
  // Quality Collections
  static CollectionReference<Map<String, dynamic>> get consultationQualityLogs => 
  ...
  static Map<String, dynamic> withTimestamps(Map<String, dynamic> data, {bool isNew = true}) {
