...
class AppLocalizations {
  ...
  String get aiDatingQuestion => isKorean ? 'AI랑 연애하면 어떤 기분일까?\n당신만의 페르소나를 만나보세요.' : 'How would it feel to date AI?\nMeet your own personas.';
  ...
  String get loginWithGoogle => isKorean ? 'Google로 로그인' : 'Sign in with Google';
  String get loginError => isKorean ? '로그인에 실패했습니다' : 'Login failed';
  String get googleLoginError => isKorean ? 'Google 로그인 중 오류가 발생했습니다.' : 'Error occurred during Google login.';
  String get loginCancelled => isKorean ? '로그인이 취소되었습니다' : 'Login cancelled';
  String get loginWithoutAccount => isKorean ? '로그인 없이 둘러보기' : 'Browse without login';
  String get logout => isKorean ? '로그아웃' : 'Logout';
  String get logoutConfirm => isKorean ? '정말 로그아웃하시겠습니까?' : 'Are you sure you want to logout?';
  String get basicInfo => isKorean ? '기본 정보' : 'Basic Information';
  String get enterBasicInfo => isKorean ? '계정 생성을 위한 기본 정보를 입력해주세요' : 'Please enter basic information to create an account';
  ...
  String get invalidEmailFormat => isKorean ? '올바른 이메일 형식이 아닙니다' : 'Invalid email format';
  String get enterPassword => isKorean ? '비밀번호를 입력해주세요' : 'Please enter password';
  String get passwordTooShort => isKorean ? '비밀번호는 6자 이상이어야 합니다' : 'Password must be at least 6 characters';
  String get enterNickname => isKorean ? '닉네임을 입력해주세요' : 'Please enter nickname';
  String get nicknameLength => isKorean ? '닉네임은 3-10자여야 합니다' : 'Nickname must be 3-10 characters';
  String get nicknameAlreadyUsed => isKorean ? '이미 사용 중인 닉네임입니다' : 'Nickname already in use';
  String get profilePhotoAndInfo => isKorean ? '프로필 사진과 기본 정보를 입력해주세요' : 'Please enter profile photo and basic information';
  ...
  String get selectBirthDate => isKorean ? '생년월일을 선택해주세요' : 'Please select birth date';
  String get personaGenderPreference => isKorean ? '페르소나 성별 선호' : 'Persona Gender Preference';
  String get showAllGenders => isKorean ? '모든 성별 페르소나 보기' : 'Show all gender personas';
  String get showOppositeGenderOnly => isKorean ? '체크하지 않으면 이성 페르소나만 표시됩니다' : 'If unchecked, only opposite gender personas will be shown';
  String get usagePurpose => isKorean ? '사용 목적' : 'Usage Purpose';
  String get selectUsagePurpose => isKorean ? 'SONA를 사용하시는 목적을 선택해주세요' : 'Please select your purpose for using SONA';
  String get selectPurpose => isKorean ? '사용 목적을 선택해주세요' : 'Please select usage purpose';

  // ===== 감정/페르소나 =====
  String get feelingQuestion => isKorean ? '지금 어떤 기분이신가요?' : 'How are you feeling?';
  ...
  String get recommendedPersonas => isKorean ? '추천 페르소나' : 'Recommended Personas';
  String get allPersonas => isKorean ? '모든 페르소나' : 'All Personas';
  String get noPersonasFound => isKorean ? '페르소나를 찾을 수 없습니다' : 'No personas found';
  String get loadingPersonas => isKorean ? '페르소나를 불러오는 중...' : 'Loading personas...';
  ...
  String get endChatConfirm => isKorean ? '대화를 종료하시겠습니까?' : 'Do you want to end this chat?';
  ...
  String get noConversationYet => isKorean ? '아직 대화가 없어요' : 'No conversation yet';
  String get sendFirstMessage => isKorean ? '첫 메시지를 보내보세요!' : 'Send your first message!';
  ...
  String waitingForChat(String name) => isKorean ? '$name님이 대화를 기다리고 있어요.' : '$name is waiting to chat.';
  String get voiceMessage => isKorean ? '🎤 음성 메시지' : '🎤 Voice message';
  String get adaptiveConversation => isKorean ? '맞춤형 대화' : 'Adaptive Conversation';
  String get adaptiveConversationDesc => isKorean ? '상대방의 말투와 스타일에 맞춰 대화합니다' : 'Adapts conversation style to match yours';
  String get signUp => isKorean ? '회원가입' : 'Sign Up';
  String conversationWith(String name) => isKorean ? '$name' : '$name';
  String get noMatchedPersonas => isKorean ? '아직 매칭된 페르소나가 없어요' : 'No matched personas yet';
  String get meetNewPersonas => isKorean ? '새로운 페르소나를 만나러 가볼까요?' : 'Want to meet new personas?';
  String get meetPersonas => isKorean ? '페르소나 만나기' : 'Meet Personas';
  String get refreshingChatList => isKorean ? '채팅 목록을 새로고침하는 중...' : 'Refreshing chat list...';
  String refreshComplete(int count) => isKorean ? '새로고침 완료! ${count}명의 매칭된 페르소나' : 'Refresh complete! $count matched personas';
  String get allPersonasChecked => isKorean ? '모든 소나를 확인했습니다!' : 'All personas checked!';
  String get wantNewEncounters => isKorean ? '새로운 만남을 원하시나요?' : 'Want new encounters?';
  String get canMeetPreviousPersonas => isKorean ? '이전에 스와이프한 페르소나들을\n다시 만날 수 있어요!' : 'You can meet personas\nyou swiped before again!';
  String get endTutorialAndLogin => isKorean ? '튜토리얼을 종료하고 로그인하시겠습니까?\n로그인하면 데이터가 저장되고 모든 기능을 사용할 수 있습니다.' : 'End tutorial and login?\nLogin to save data and use all features.';
  String get dailyLimitTitle => isKorean ? '일일 메시지 한도 도달' : 'Daily message limit reached';
  String get dailyLimitDescription => isKorean ? '오늘의 메시지 100개를 모두 사용하셨습니다.\n하트 1개를 사용하여 다시 100개의 메시지를 보낼 수 있습니다.' : 'You\'ve used all 100 messages today.\nUse 1 heart to send 100 more messages.';
  String get messageLimitReset => isKorean ? '메시지 한도가 리셋되었습니다!' : 'Message limit reset!';
  String get heartInsufficient => isKorean ? '하트가 부족합니다' : 'Not enough hearts';
  String get messageSendFailed => isKorean ? '메시지 전송에 실패했습니다. 다시 시도해주세요.' : 'Failed to send message. Please try again.';
  String get leaveChatTitle => isKorean ? '채팅방 나가기' : 'Leave Chat';
  String get leaveChatConfirm => isKorean ? '이 채팅방을 나가시겠습니까?\n채팅 목록에서 사라집니다.' : 'Leave this chat?\nIt will disappear from your chat list.';
  ...
  String purchaseConfirmMessage(String product, String price) => 
      isKorean ? '$product을(를) $price에 구매하시겠습니까?' : 'Purchase $product for $price?';
  String get purchasePending => isKorean ? '이미 구매가 진행 중입니다' : 'Purchase already in progress';
  String get purchaseFailed => isKorean ? '구매를 시작할 수 없습니다' : 'Cannot start purchase';
  String get storeNotAvailable => isKorean ? '스토어를 사용할 수 없습니다' : 'Store is not available';
  String get storeConnectionError => isKorean ? '스토어 연결 오류' : 'Store connection error';
  ...
  String get heartDescription => isKorean ? '매칭과 채팅에 사용할 수 있는 하트' : 'Hearts for matching and chatting';

  // ===== 설정 =====
  String get settings => isKorean ? '설정' : 'Settings';
  String get profile => isKorean ? '프로필' : 'Profile';
  String get profilePhotoUpdated => isKorean ? '프로필 사진이 업데이트되었습니다' : 'Profile photo has been updated';
  ...
  String get notificationSettings => isKorean ? '알림 설정' : 'Notification Settings';
  String get pushNotifications => isKorean ? '푸시 알림' : 'Push Notifications';
  String get newMessageNotification => isKorean ? '새로운 메시지 알림을 받습니다' : 'Receive new message notifications';
  String get soundSettings => isKorean ? '소리 설정' : 'Sound Settings';
  String get effectSound => isKorean ? '효과음' : 'Sound Effects';
  String get effectSoundDescription => isKorean ? '앱 내 효과음을 켜거나 끕니다' : 'Turn app sound effects on or off';
  ...
  String get purchasePolicy => isKorean ? '구매 및 환불 정책' : 'Purchase & Refund Policy';
  ...
  String get deleteAccountWarning => isKorean ? '모든 데이터가 삭제됩니다' : 'All data will be deleted';
  String get deleteAccountConfirm => isKorean ? '정말로 계정을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.' : 'Are you sure you want to delete your account? This action cannot be undone.';
  
  // Help Dialog
  String get howToUse => isKorean ? 'SONA 사용 방법' : 'How to use SONA';
  String get matchPersonaStep => isKorean ? '1. 페르소나 매칭: 좌우로 스와이프하여 마음에 드는 AI 페르소나를 선택하세요.' : '1. Match Personas: Swipe left or right to select your favorite AI personas.';
  String get startConversationStep => isKorean ? '2. 대화 시작: 매칭된 페르소나와 자유롭게 대화를 나누세요.' : '2. Start Conversation: Chat freely with matched personas.';
  String get developRelationshipStep => isKorean ? '3. 관계 발전: 대화를 통해 친밀도를 쌓고 특별한 관계로 발전시켜보세요.' : '3. Develop Relationship: Build intimacy through conversations and develop special relationships.';
  String get inquiries => isKorean ? '문의사항' : 'Inquiries';
  String get appTagline => isKorean ? 'AI와 함께하는 특별한 만남' : 'Special encounters with AI';
  String get emotionBasedEncounters => isKorean ? '감정으로 만나는 특별한 인연' : 'Special encounters through emotions';
  ...
  String chattingWithPersonas(int count) => isKorean ? '${count}명의 소나와 대화중' : 'Chatting with $count personas';

  // ===== 에러 메시지 =====
  String get networkError => isKorean ? '네트워크 연결을 확인해주세요' : 'Please check your network connection';
  String get somethingWentWrong => isKorean ? '문제가 발생했습니다' : 'Something went wrong';
  String get refreshFailed => isKorean ? '새로고침 실패. 다시 시도해주세요.' : 'Refresh failed. Please try again.';
  String get loginFailedTryAgain => isKorean ? '로그인에 실패했습니다. 다시 시도해주세요.' : 'Login failed. Please try again.';
  String get imageNotAvailable => isKorean ? '이미지가 없습니다' : 'Image not available';
  String get internetConnectionCheck => isKorean ? '인터넷 연결을 확인해주세요' : 'Please check your internet connection';
  String get purchaseAlreadyInProgress => isKorean ? '이미 구매가 진행 중입니다' : 'Purchase already in progress';
  String get cannotStartPurchase => isKorean ? '구매를 시작할 수 없습니다' : 'Cannot start purchase';
  String get loadingProductInfo => isKorean ? '상품 정보를 불러오는 중...' : 'Loading product information...';
  String get retryButton => isKorean ? '다시 시도' : 'Retry';
  String get purchaseConfirmTitle => isKorean ? '구매 확인' : 'Purchase Confirmation';
  String purchaseConfirmContent(String product, String price) => isKorean ? '$product을(를) $price에 구매하시겠습니까?' : 'Purchase $product for $price?';
  String get loginCompleted => isKorean ? '로그인이 완료되었습니다 🎉' : 'Login completed 🎉';
  String get heartInsufficientPleaseCharge => isKorean ? '하트가 부족합니다. 하트를 충전해주세요.' : 'Not enough hearts. Please recharge hearts.';
  ...
  String get selectAtLeastOneInterest => isKorean ? '관심사를 최소 1개 이상 선택해주세요' : 'Please select at least one interest';
  String get agreeToRequiredTerms => isKorean ? '필수 약관에 동의해주세요' : 'Please agree to required terms';
  String get previous => isKorean ? '이전' : 'Previous';
  String get signupComplete => isKorean ? '가입완료' : 'Sign Up Complete';
  String get casualConversation => isKorean ? '편안하고 캐주얼한 대화' : 'Comfortable and casual conversation';
  String get casualConversationDesc => isKorean ? '친구처럼 편하게 대화해요' : 'Chat comfortably like friends';
  String get formalConversation => isKorean ? '정중하고 포멀한 대화' : 'Polite and formal conversation';
  String get formalConversationDesc => isKorean ? '공손하고 예의 바르게 대화해요' : 'Chat politely and courteously';
  String get specialRelationship => isKorean ? '특별한 관계 맺기' : 'Build special relationships';
  String get specialRelationshipDesc => isKorean ? '서로를 이해하고 깊은 유대감을 쌓아요' : 'Understand each other and build deep bonds';
  String get emotionalSupport => isKorean ? '정서적 지원과 위로' : 'Emotional support and comfort';
  String get emotionalSupportDesc => isKorean ? '고민을 나누고 따뜻한 위로를 받아요' : 'Share your concerns and receive warm comfort';
  String get entertainmentAndFun => isKorean ? '재미있는 오락과 놀이' : 'Entertainment and fun';
  String get entertainmentAndFunDesc => isKorean ? '즐거운 게임과 유쾌한 대화를 즐겨요' : 'Enjoy fun games and pleasant conversations';
  String get accountDeletionTitle => isKorean ? '계정 삭제' : 'Delete Account';
  String get accountDeletionContent => isKorean ? '정말로 계정을 삭제하시겠습니까?\n이 작업은 되돌릴 수 없습니다.' : 'Are you sure you want to delete your account?\nThis action cannot be undone.';
  ...
  String get accountDeletionError => isKorean ? '계정 삭제 중 오류가 발생했습니다.' : 'Error occurred while deleting account.';
  String get incorrectPassword => isKorean ? '비밀번호가 올바르지 않습니다.' : 'Password is incorrect.';
  String get recentLoginRequired => isKorean ? '보안을 위해 다시 로그인해주세요.' : 'Please login again for security.';
  String get passwordConfirmation => isKorean ? '비밀번호 확인' : 'Password Confirmation';
  String get passwordConfirmationDesc => isKorean ? '계정 삭제를 위해 비밀번호를 다시 입력해주세요.' : 'Please re-enter your password to delete account.';
  String get deletingAccount => isKorean ? '계정을 삭제하는 중...' : 'Deleting account...';
  String get accountDeletedSuccess => isKorean ? '계정이 성공적으로 삭제되었습니다.' : 'Account successfully deleted.';
  String get monitoringTitle => isKorean ? '상담 품질 모니터링' : 'Chat Quality Monitoring';
  ...
  String get reportInProgress => isKorean ? '신고를 접수하는 중...' : 'Submitting report...';
  String get reportSubmitted => isKorean ? '신고가 접수되었습니다. 검토 후 조치하겠습니다.' : 'Report submitted. We will review and take action.';
  String reportError(String error) => isKorean ? '신고 접수 중 오류가 발생했습니다: $error' : 'Error submitting report: $error';
  String get loginRequiredToReport => isKorean ? '신고하려면 로그인이 필요합니다' : 'Login required to report';
  ...
  String get notificationPermissionRequired => isKorean ? '알림 권한 필요' : 'Notification Permission Required';
  String get notificationPermissionDesc => isKorean ? '새로운 메시지를 받으려면 알림 권한이 필요합니다.' : 'Notification permission is required to receive new messages.';
  String get later => isKorean ? '나중에' : 'Later';
  String get tryAgainLater => isKorean ? '나중에 다시 시도해주세요' : 'Please try again later';
  String get noInternetConnection => isKorean ? '인터넷 연결이 없습니다' : 'No internet connection';
  String get serverError => isKorean ? '서버 오류가 발생했습니다' : 'Server error occurred';
  ...
  String get unauthorizedAccess => isKorean ? '접근 권한이 없습니다' : 'Unauthorized access';
  String get inappropriateContent => isKorean ? '부적절한 콘텐츠' : 'Inappropriate content';
  ...
  String get personalInfoExposure => isKorean ? '개인정보 노출' : 'Personal info exposure';
  String get copyrightInfringement => isKorean ? '저작권 침해' : 'Copyright infringement';
  String get selectReportReason => isKorean ? '신고 사유를 선택해주세요:' : 'Please select report reason:';
  String get detailedReason => isKorean ? '상세 사유' : 'Detailed reason';
  String get explainReportReason => isKorean ? '신고 사유를 자세히 설명해주세요' : 'Please explain the report reason in detail';
  ...
  String get notificationPermission => isKorean ? '알림 권한' : 'Notification Permission';
  String get permissionDenied => isKorean ? '권한이 거부되었습니다' : 'Permission denied';
  String get openSettings => isKorean ? '설정 열기' : 'Open Settings';
  String get cameraPermissionDesc => isKorean ? '프로필 사진 촬영을 위해 카메라 접근이 필요합니다.' : 'Camera access is required to take profile photos.';
  String get galleryPermissionDesc => isKorean ? '프로필 사진 선택을 위해 갤러리 접근이 필요합니다.' : 'Gallery access is required to select profile photos.';
  String permissionDeniedMessage(String permissionName) => isKorean ? '$permissionName 권한이 거부되었습니다.\n설정에서 권한을 허용해주세요.' : '$permissionName permission was denied.\nPlease allow permission in settings.';
  ...
  // ===== 회원가입 추가 문구 =====
  String get requiredTermsAgreement => isKorean ? '필수 약관에 동의해주세요' : 'Please agree to the required terms';
  String get nicknameLengthError => isKorean ? '닉네임은 2-10자여야 합니다' : 'Nickname must be 2-10 characters';
  String get serviceTermsAgreement => isKorean ? '서비스 이용약관에 동의해주세요' : 'Please agree to the Terms of Service';
  String get privacyPolicyAgreement => isKorean ? '개인정보 처리방침에 동의해주세요' : 'Please agree to the Privacy Policy';
  String get completeSignup => isKorean ? '가입완료' : 'Complete Sign Up';
  String get basicInfoDescription => isKorean ? '계정 생성을 위한 기본 정보를 입력해주세요' : 'Please enter basic information to create an account';
  String get nicknameLabel => isKorean ? '닉네임 *' : 'Nickname *';
  String get profileInfo => isKorean ? '프로필 정보' : 'Profile Information';
  String get profileInfoDescription => isKorean ? '프로필 사진과 기본 정보를 입력해주세요' : 'Please enter your profile photo and basic information';
  ...
  String get selfIntroductionHint => isKorean ? '간단한 자기소개를 작성해주세요 (선택)' : 'Please write a brief introduction (Optional)';
  ...
  String get selectInterests => isKorean ? '관심사를 선택해주세요 (최소 1개)' : 'Please select your interests (at least 1)';
  String get preferredTopics => isKorean ? '선호하는 대화 주제' : 'Preferred Conversation Topics';
  String get whatTopicsToTalk => isKorean ? '어떤 주제로 대화하고 싶으신가요? (선택사항)' : 'What topics would you like to talk about? (Optional)';
  String get preferredConversationStyle => isKorean ? '선호하는 대화 스타일' : 'Preferred Conversation Style';
  String get preferredMbti => isKorean ? '선호하는 MBTI (선택사항)' : 'Preferred MBTI (Optional)';
  String get selectPreferredMbti => isKorean ? '특정 MBTI 유형의 페르소나를 선호하신다면 선택해주세요' : 'If you prefer personas with specific MBTI types, please select';
  String get termsAgreement => isKorean ? '약관 동의' : 'Terms Agreement';
  String get termsAgreementDescription => isKorean ? '서비스 이용을 위한 약관에 동의해주세요' : 'Please agree to the terms for using the service';
  String get preferredPersonaType => isKorean ? '선호하는 페르소나 유형' : 'Preferred Persona Type';
  String get sonaUsagePurpose => isKorean ? 'SONA를 사용하시는 목적을 선택해주세요' : 'Please select your purpose for using SONA';
  String get preferredPersonaAgeRange => isKorean ? '선호하는 페르소나 나이 범위 *' : 'Preferred Persona Age Range *';
  String get preferenceSettings => isKorean ? '선호 설정' : 'Preference Settings';
  String get aiPersonaPreferenceDescription => isKorean ? 'AI 페르소나 매칭을 위한 선호도를 설정해주세요' : 'Please set your preferences for AI persona matching';

  // ===== 채팅 화면 =====
  String get loginRequiredService => isKorean ? '로그인이 필요한 서비스입니다' : 'Login required for this service';
  ...
  String get selectPersona => isKorean ? '페르소나를 선택해주세요' : 'Please select a persona';
  ...
  String get unexpectedLoginError => isKorean ? '로그인 중 예상치 못한 오류가 발생했습니다' : 'An unexpected error occurred during login';
  String get googleLoginCanceled => isKorean ? '구글 로그인이 취소되었습니다.\n다시 시도해주세요.' : 'Google login was canceled.\nPlease try again.';
  String get passwordResetEmailPrompt => isKorean ? '비밀번호를 재설정할 이메일을 입력해주세요' : 'Please enter your email to reset password';
  String get invalidEmailFormatError => isKorean ? '올바른 이메일 형식을 입력해주세요' : 'Please enter a valid email format';
  String get passwordResetEmailSent => isKorean ? '비밀번호 재설정 이메일을 발송했습니다. 이메일을 확인해주세요.' : 'Password reset email has been sent. Please check your email.';
  String get loginTab => isKorean ? '로그인' : 'Login';
  String get signupTab => isKorean ? '회원가입' : 'Sign Up';
  String get browseWithoutLogin => isKorean ? '로그인 없이 둘러보기' : 'Browse without login';
  ...
  String get simpleInfoRequired => isKorean ? 'AI 페르소나와의 매칭을 위해\n간단한 정보가 필요해요' : 'Simple information is required\nfor matching with AI personas';

  // ===== 페르소나 선택 화면 =====
  String get endTutorial => isKorean ? '튜토리얼 종료' : 'End Tutorial';
  String get endTutorialMessage => isKorean ? '튜토리얼을 종료하고 로그인하시겠습니까?\n로그인하면 데이터가 저장되고 모든 기능을 사용할 수 있습니다.' : 'Do you want to end the tutorial and login?\nBy logging in, your data will be saved and you can use all features.';
  String get loginFailed => isKorean ? '로그인에 실패했습니다. 다시 시도해주세요.' : 'Login failed. Please try again.';
  String get loginComplete => isKorean ? '로그인이 완료되었습니다 🎉' : 'Login completed 🎉';

  // ===== 프로필 편집 화면 =====
  String get profileUpdated => isKorean ? '프로필이 업데이트되었습니다' : 'Profile has been updated';
  String get profileUpdateFailed => isKorean ? '프로필 업데이트 실패' : 'Profile update failed';
  String get profileEdit => isKorean ? '프로필 편집' : 'Edit Profile';
  String get complete => isKorean ? '완료' : 'Done';
  String get changeProfilePhoto => isKorean ? '프로필 사진 변경' : 'Change Profile Photo';
  String get nicknameInUse => isKorean ? '이미 사용 중인 닉네임입니다' : 'This nickname is already in use';
  String get showAllGenderPersonas => isKorean ? '모든 성별 페르소나 보기' : 'Show all gender personas';
  String get onlyOppositeGenderNote => isKorean ? '체크하지 않으면 이성 페르소나만 표시됩니다' : 'If unchecked, only opposite gender personas will be shown';

  // ===== 채팅 목록 화면 =====
  String get startConversation => isKorean ? '대화를 시작해보세요!' : 'Start a conversation!';
  String get startConversationWithSona => isKorean ? '소나와 친구처럼 대화를 시작해보세요!' : 'Start chatting with Sona like a friend!';
  ...
  String minutesAgo(int minutes) => isKorean ? '$minutes분 전' : '$minutes minutes ago';
  String get justNow => isKorean ? '방금 전' : 'Just now';
  String isTyping(String name) => isKorean ? '$name님이 입력 중...' : '$name is typing...';
  ...
  // ===== 페르소나 카드 =====
  String get tapToSwipePhotos => isKorean ? '좌우 탭으로 사진 넘기기' : 'Tap left/right to swipe photos';
  ...
  // Privacy Policy
  String get sonaPrivacyPolicy => isKorean ? 'SONA 개인정보 처리방침' : 'SONA Privacy Policy';
  String get lastUpdated => isKorean ? '마지막 업데이트: 2024년 7월 24일' : 'Last updated: July 24, 2024';
  
  String get privacySection1Title => isKorean ? '1. 개인정보 수집 및 이용 목적' : '1. Purpose of Collection and Use of Personal Information';
  String get privacySection1Content => isKorean ? '''SONA(이하 "앱")는 다음 목적으로 개인정보를 수집 및 이용합니다:

• 회원 가입 및 계정 관리
• AI 페르소나 대화 서비스 제공
• 서비스 품질 향상 및 맞춤형 서비스 제공
• 고객 지원 및 문의 대응
• 서비스 이용 통계 분석''' : '''SONA (the "App") collects and uses personal information for the following purposes:
...
• Service usage statistics analysis''';
  ...
  String get privacySection2Title => isKorean ? '2. 수집하는 개인정보 항목' : '2. Personal Information We Collect';
  String get privacySection2Content => isKorean ? '''앱에서 수집하는 개인정보는 다음과 같습니다:
...
선택 정보:
• 사용자 설정 정보
• 피드백 및 문의 내용''' : '''The personal information collected by the app includes:
...
• Feedback and inquiry content''';
  ...
  String get privacySection3Title => isKorean ? '3. 개인정보 보관 및 이용 기간' : '3. Retention and Use Period of Personal Information';
  String get privacySection3Content => isKorean ? '''• 회원 탈퇴 시까지 보관하며, 탈퇴 즉시 파기됩니다.
• 법령에 의해 보관이 필요한 경우 해당 기간까지 보관합니다.
• 서비스 이용 기록은 통계 분석 후 즉시 익명화됩니다.''' : '''• Retained until membership withdrawal and deleted immediately upon withdrawal.
...
• Service usage records are anonymized immediately after statistical analysis.''';
  ...
  String get privacySection4Title => isKorean ? '4. 개인정보 제3자 제공' : '4. Provision of Personal Information to Third Parties';
  String get privacySection4Content => isKorean ? '''앱은 다음의 경우를 제외하고는 개인정보를 제3자에게 제공하지 않습니다:

• 사용자의 동의가 있는 경우
• 법령에 의해 요구되는 경우
• OpenAI 등 AI 서비스 제공을 위한 필요한 경우 (대화 내용은 익명화하여 전송)''' : '''The app does not provide personal information to third parties except in the following cases:

• With user consent
• When required by law
• When necessary for AI service provision such as OpenAI (conversations are anonymized before transmission)''';
  
  String get privacySection5Title => isKorean ? '5. 개인정보 보호를 위한 기술적 보호조치' : '5. Technical Protection Measures for Personal Information';
  String get privacySection5Content => isKorean ? '''• Firebase 보안 시스템을 통한 데이터 암호화
• HTTPS 통신을 통한 전송 구간 암호화
• 접근 권한 관리 및 로그 모니터링
• 정기적인 보안 점검 및 업데이트''' : '''• Data encryption through Firebase security system
...
• Regular security checks and updates''';
  ...
  String get privacySection6Content => isKorean ? '''사용자는 다음 권리를 행사할 수 있습니다:
...
데이터 삭제 요청 시 처리 기간:
• 일반 요청: 3영업일 이내
• 회원 탈퇴: 즉시 처리''' : '''Users can exercise the following rights:
...
• Membership withdrawal: Immediate processing''';
  ...
  String get privacySection7Title => isKorean ? '7. 개인정보보호책임자' : '7. Personal Information Protection Officer';
  String get privacySection7Content => isKorean ? '''개인정보 처리에 관한 문의사항이 있으시면 아래로 연락주시기 바랍니다:

• 이메일: privacy@sona-app.com
• 개인정보보호책임자: SONA 개발팀
• 처리 부서: 개발운영팀''' : '''For inquiries regarding personal information processing, please contact us at:
...
• Processing Department: Development Operations Team''';
  ...
  String get privacySection8Title => isKorean ? '8. 개인정보 처리방침 변경' : '8. Changes to Privacy Policy';
  String get privacySection8Content => isKorean ? '''본 개인정보 처리방침은 법령, 정책 또는 보안기술의 변경에 따라 내용의 추가, 
삭제 및 수정이 있을 시에는 변경 최소 7일 전부터 앱을 통해 변경 이유 및 내용 등을 공지하도록 하겠습니다.

본 개인정보 처리방침은 2024년 7월 24일부터 적용됩니다.''' : '''This privacy policy may be added, deleted, or modified according to changes in laws, policies, or security technologies. 
...
This privacy policy is effective from July 24, 2024.''';
  ...
  String get themeDescription => isKorean ? '앱의 외관을 원하는 대로 설정할 수 있습니다' : 'You can customize the app appearance as you like';
  String get systemTheme => isKorean ? '시스템 설정 따르기' : 'Follow System';
  String get systemThemeDesc => isKorean ? '기기의 다크 모드 설정에 따라 자동으로 변경됩니다' : 'Automatically changes based on device dark mode settings';
  ...
  // Purchase Policy
  String get purchaseAndRefundPolicy => isKorean ? '구매 및 환불 정책' : 'Purchase and Refund Policy';
  String get sonaPurchasePolicy => isKorean ? 'SONA 구매 및 환불 정책' : 'SONA Purchase and Refund Policy';
...
• 50 Hearts: ₩4,900 (18% discount)''';
  ...
  String get purchaseSection2Title => isKorean ? '2. 결제 방법' : '2. Payment Methods';
  String get purchaseSection2Content => isKorean ? '''• Google Play Store: Google Play 계정에 등록된 결제 수단
• Apple App Store: Apple ID에 등록된 결제 수단

결제는 구매 확인 시 자동으로 청구됩니다.''' : '''• Google Play Store: Payment method registered to your Google Play account
...
※ Refund processing may take 3-5 business days according to store policy.''';
  ...
  String get purchaseSection5Title => isKorean ? '5. 이용 제한' : '5. Usage Restrictions';
  String get purchaseSection5Content => isKorean ? '''다음의 경우 구매한 상품 이용이 제한될 수 있습니다:
• 부정한 방법으로 구매한 경우
• 환불 후 재구매를 반복하는 경우
• 서비스 이용약관을 위반한 경우

이용 제한 시 구매한 상품에 대한 환불은 불가합니다.''' : '''Usage of purchased items may be restricted in the following cases:
...
Refunds are not available for purchased items when usage is restricted.''';
  ...
  String get purchaseSection6Content => isKorean ? '''구매 관련 문의사항이 있으시면 아래로 연락주세요:

• 이메일: support@sona-app.com
• 고객센터 운영시간: 평일 10:00 - 18:00
• 답변 소요시간: 1-2영업일

구매 영수증과 함께 문의하시면 더 빠른 처리가 가능합니다.''' : '''For purchase-related inquiries, please contact us at:
...
Faster processing is available when you provide your purchase receipt.''';
  ...
  String get emotionalConnection => isKorean ? '정서적 교감' : 'Emotional Connection';
  ...
  String ageRange(int min, int max) => isKorean ? '$min~$max세' : '$min-$max years old';
  ...
  String get termsOfServiceAgree => isKorean ? '서비스 이용약관 동의' : 'Agree to Terms of Service';
  String get privacyPolicyAgree => isKorean ? '개인정보 처리방침 동의' : 'Agree to Privacy Policy';
  String get marketingAgree => isKorean ? '마케팅 정보 수신 동의 (선택)' : 'Agree to Marketing Information (Optional)';
