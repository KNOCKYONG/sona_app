...
class AppLocalizations {
  ...
  String get nicknameLengthError =>
      isKorean ? '닉네임은 3자 이상 10자 이하로 입력해주세요' : 'Nickname must be between 3 and 10 characters';
  String get nicknameLabel =>
      isKorean ? '닉네임 (필수)' : 'Nickname (Required)';
  String get nicknameHelperText =>
      isKorean ? '3자 이상 10자 이하로 입력해주세요' : 'Enter between 3 and 10 characters';
  String get nicknamePlaceholder =>
      isKorean ? '닉네임 (3~10자 한글/영문/숫자)' : 'Nickname (3-10 chars, Korean/English/Numbers)';
  ...
  String get myGenderSection => isKorean ? '내 성별 (선택)' : 'My Gender (Optional)';
  String get personaGenderSection => isKorean ? '만나고 싶은 페르소나 성별' : 'Persona Gender Preference';
  String get genderSelectionInfo => isKorean 
      ? '선택하지 않으면 모든 성별의 페르소나를 만날 수 있어요' 
      : 'If not selected, you can meet personas of all genders';
  String get showAllGendersOption => isKorean ? '모든 성별 보기' : 'Show All Genders';
  String get genderPreferenceActive => isKorean 
      ? '모든 성별의 페르소나를 만날 수 있어요' 
      : 'You can meet personas of all genders';
  String get genderPreferenceInactive => isKorean 
      ? '이성 페르소나만 보여집니다' 
      : 'Only opposite gender personas will be shown';
  String get genderPreferenceDisabled => isKorean 
      ? '성별을 선택하면 이성만 보기 옵션이 활성화됩니다' 
      : 'Select your gender to enable opposite gender only option';
  
  // Account and profile page
  String get accountAndProfile => isKorean ? '계정 & 프로필 정보' : 'Account & Profile Information';
  String get enterBasicInformation => isKorean ? '기본 정보를 입력해주세요' : 'Please enter basic information';
  String get optional => isKorean ? '선택' : 'Optional';
  String get previous => isKorean ? '이전' : 'Previous';
  String get completeSignup => isKorean ? '가입 완료' : 'Complete Sign Up';
  String get referrerEmail => isKorean ? '친구의 이메일을 입력해주세요' : 'Enter your friend\'s email';
  String get referrerEmailLabel => isKorean ? '추천인 이메일 (선택)' : 'Referrer Email (Optional)';
  String get referrerEmailHelper => isKorean ? '친구의 추천으로 가입하시나요?' : 'Joining through a friend\'s recommendation?';
  String get year => isKorean ? '년' : 'Year';
  String get month => isKorean ? '월' : 'Month';
  String get day => isKorean ? '일' : 'Day';
  String get selfIntroduction => isKorean ? '자기소개 (선택)' : 'Introduction (Optional)';
  String get selfIntroductionHint => isKorean ? '간단한 자기소개를 작성해주세요' : 'Write a brief introduction about yourself';
  ...
  String get messagesRemaining => isKorean ? '메시지 잔량' : 'Messages Remaining';
...
For inquiries, please contact us through the in-app customer center or at support@sona-app.com.''';
  ...
  String get reportChatError => isKorean ? '대화 오류 신고' : 'Report Chat Error';
  String get selectProblematicMessage => isKorean ? '문제가 있는 메시지를 선택해주세요 (선택사항)' : 'Select the problematic message (optional)';
  String get describeError => isKorean ? '어떤 문제가 있나요?' : 'What is the problem?';
  String get errorDescriptionHint => isKorean ? '예: 이상한 대답을 했어요, 반복적으로 같은 말만 해요, 맥락에 맞지 않는 대답을 해요...' : 'e.g., Gave strange answers, Repeats the same thing, Gives contextually inappropriate responses...';
  String get sendReport => isKorean ? '신고하기' : 'Send Report';
  ...
  // ===== Hardcoded Text Fixes (2025-01-30) =====
  ...
  String cacheDeleteError(String error) => 
      isKorean ? '캐시 삭제 중 오류가 발생했습니다: $error' : 'Error deleting cache: $error';
  
  // Blocked Personas Messages  
  String unblockPersonaConfirm(String name) => 
      isKorean ? '$name의 차단을 해제하시겠습니까?' : 'Unblock $name?';
