...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get chatErrorAnalysisInfo => 'آخری 10 گفتگو کا تجزیہ کیا جا رہا ہے۔';

  @override
  String get whatWasAwkward => 'کیا چیز عجیب لگی؟';

  @override
  String get errorExampleHint => 'مثال: بولنے کا عجیب انداز (~nya اختتام)...';
  ...
  @override
  String get alwaysShowTranslationOn => 'ہمیشہ ترجمہ دکھائیں';

  @override
  String get alwaysShowTranslationOff => 'خودکار ترجمہ چھپائیں';

  @override
  String get translationErrorAnalysisInfo =>
      'ہم منتخب پیغام اور اس کے ترجمے کا تجزیہ کریں گے۔';

  @override
  String get whatWasWrongWithTranslation => 'ترجمے میں کیا غلط تھا؟';

  @override
  String get translationErrorHint =>
      'مثال: غلط معنی، غیر فطری اظہار، غلط سیاق و سباق...';

  @override
  String get pleaseSelectMessage => 'پہلے ایک پیغام منتخب کریں';

  @override
  String get myPersonas => 'میرے کردار';

  @override
  String get createPersona => 'کردار بنائیں';

  @override
  String get tellUsAboutYourPersona => 'اپنے کردار کے بارے میں بتائیں';

  @override
  String get enterPersonaName => 'کردار کا نام درج کریں';

  @override
  String get describeYourPersona => 'اپنے کردار کا مختصر بیان کریں';

  @override
  String get profileImage => 'پروفائل تصویر';

  @override
  String get uploadPersonaImages => 'اپنے کردار کے لیے تصاویر اپ لوڈ کریں';

  @override
  String get mainImage => 'اصل تصویر';
  ...
  @override
  String get mbtiQuestion => 'شخصیت کا سوال';

  @override
  String get mbtiComplete => 'شخصیت کا ٹیسٹ مکمل!';

  @override
  String get mbtiTest => 'MBTI ٹیسٹ';

  @override
  String get mbtiStepDescription =>
      'آئیے طے کریں کہ آپ کی شخصیت کی کیا خصوصیت ہونی چاہیے۔ ان کے کردار کو تشکیل دینے کے لیے سوالات کا جواب دیں۔';

  @override
  String get startTest => 'ٹیسٹ شروع کریں';

  @override
  String get personalitySettings => 'شخصیت کی ترتیبات';

  @override
  String get speechStyle => 'بات چیت کا انداز';

  @override
  String get conversationStyle => 'گفتگو کا انداز';

  @override
  String get shareWithCommunity => 'کمیونٹی کے ساتھ شیئر کریں';

  @override
  String get shareDescription =>
      'آپ کا کردار منظوری کے بعد دوسرے صارفین کے ساتھ شیئر ہوگا';

  @override
  String get sharePersona => 'کردار شیئر کریں';

  @override
  String get willBeSharedAfterApproval => 'ایڈمن کی منظوری کے بعد شیئر ہوگا';

  @override
  String get privatePersonaDescription => 'صرف آپ اس کردار کو دیکھ سکتے ہیں';

  @override
  String get create => 'بنائیں';

  @override
  String get personaCreated => 'کردار کامیابی سے بنایا گیا!';

  @override
  String get createFailed => 'کردار بنانے میں ناکامی';

  @override
  String get pendingApproval => 'منظوری کا انتظار';

  @override
  String get approved => 'منظور شدہ';

  @override
  String get privatePersona => 'نجی';

  @override
  String get noPersonasYet => 'ابھی کوئی کردار نہیں';

  @override
  String get createYourFirstPersona =>
      'اپنا پہلا کردار بنائیں اور اپنا سفر شروع کریں';

  @override
  String get deletePersona => 'کردار ڈیلیٹ کریں';

  @override
  String get deletePersonaConfirm =>
      'کیا آپ واقعی اس کردار کو ڈیلیٹ کرنا چاہتے ہیں؟';

  @override
  String get personaDeleted => 'کردار کامیابی سے ڈیلیٹ ہوگیا';

  @override
  String get deleteFailed => 'ڈیلیٹ کرنے میں ناکامی';

  @override
  String get personaLimitReached => 'آپ 3 شخصیات کی حد تک پہنچ گئے ہیں';

  @override
  String get personaName => 'نام';

  @override
  String get personaAge => 'عمر';

  @override
  String get personaDescription => 'تفصیل';

  @override
  String get personaNameHint => 'شخصیت کا نام درج کریں';

  @override
  String get personaDescriptionHint => 'شخصیت کی وضاحت کریں';

  @override
  String get loginRequiredContent => 'جاری رکھنے کے لیے لاگ ان کریں';

  @override
  String get reportErrorButton => 'خرابی کی اطلاع دیں';

  @override
  String get speechStyleFriendly => 'دوستانہ';

  @override
  String get speechStylePolite => 'مؤدب';

  @override
  String get speechStyleChic => 'شیک';

  @override
  String get speechStyleLively => 'زندہ دل';

  @override
  String get conversationStyleTalkative => 'باتونی';

  @override
  String get conversationStyleQuiet => 'خاموش';

  @override
  String get conversationStyleEmpathetic => 'ہمدرد';

  @override
  String get conversationStyleLogical => 'منطقی';

  @override
  String get interestMusic => 'موسیقی';

  @override
  String get interestMovies => 'فلمیں';

  @override
  String get interestReading => 'مطالعہ';

  @override
  String get interestTravel => 'سفر';

  @override
  String get interestExercise => 'ورزش';

  @override
  String get interestGaming => 'گیمنگ';

  @override
  String get interestCooking => 'کھانا پکانا';

  @override
  String get interestFashion => 'فیشن';

  @override
  String get interestArt => 'فن';

  @override
  String get interestPhotography => 'فوٹوگرافی';

  @override
  String get interestTechnology => 'ٹیکنالوجی';

  @override
  String get interestScience => 'سائنس';

  @override
  String get interestHistory => 'تاریخ';

  @override
  String get interestPhilosophy => 'فلسفہ';

  @override
  String get interestPolitics => 'سیاست';

  @override
  String get interestEconomy => 'معیشت';

  @override
  String get interestSports => 'کھیل';

  @override
  String get interestAnimation => 'انیمیشن';

  @override
  String get interestKpop => 'K-POP';

  @override
  String get interestDrama => 'ڈرامہ';

  @override
  String get imageOptionalR2 =>
      'تصاویر اختیاری ہیں۔ صرف R2 تشکیل دینے پر اپ لوڈ ہوں گی۔';
  ...
  @override
  String get maxFiveItems => 'زیادہ سے زیادہ 5 آئٹمز';
  ...
  String startChatWithPersona(String personaName) {
    return '$personaName کے ساتھ بات چیت شروع کریں؟';
  }

  @override
  String reengagementNotificationSent(String personaName, String riskPercent) {
    return '$personaName کو دوبارہ مشغولیت کی اطلاع بھیجی گئی (خطرہ: $riskPercent%)';
  }
