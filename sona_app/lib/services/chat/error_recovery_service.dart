...
class ErrorRecoveryService {
  ...
  void trackError({
    ...
    debugPrint('📊 Error tracked for persona $personaId: $errorType (total: ${tracker.totalErrors})');
  }
...
class _ErrorTracker {
  ...
  void addError(String type, String message) {
    ...
    // 오래된 에러 제거 (24시간 이상)
    _errors.removeWhere((e) => 
      DateTime.now().difference(e.timestamp) > Duration(hours: 24)
    );
  }
