...
class R2ValidationCache {
  ...
  static Future<void> _setPersistentCache(String personaId, bool hasR2Image) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  static Future<Map<String, dynamic>> _getCacheMeta(SharedPreferences prefs) async {
